...
@section('link_halaman')
  <a href="{{ url('/beranda') }}">Dashboard </a> >> <a href="{{ url('/orang_tua') }}"> Orang tua</a>
@endsection
                        ...
                        <tbody>
                        		@foreach ($data_orangtua as $item)
                        			<tr>
                        				...
                        				<td>{{$item->nohp_orangtua}}</td>
										<td width="80px">
											<a href="#" class="btn btn-info" data-toggle="modal" data-target="#modalEdit-{{$item->id_orangtua}}">
